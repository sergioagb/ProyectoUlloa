...
<v-card class="pa-5">
<v-card-title>Añadir Nuevo Celular </v-card-title>
<v-divider></v-divider>
<v-form ref="form" @submit.prevent="submitForm" class="pa-5" encrype="multipart/form-data">
...
<v-file-input @change="selectFile" :rules="rules" show-size counter multiple label="SelectImage" ></v-file-input>
